  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: t.bg }}>
      ...
      <div style={{ padding: '0 20px 8px', display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{ fontSize: 13.5, color: t.textSec }}>{group.emoji} {group.name}</div>
        <div style={{ width: 3, height: 3, borderRadius: 3, background: t.textTer }} />
        <div style={{ fontSize: 13.5, color: t.textSec }}>{active.length}品 未購入</div>
      </div>
